...
<title>Administrator Page | Administrators</title>
</head>
        ...
        <div class="container-fluid">
            ...
            <div class="">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active"><a href="/admin/administrators">Administrators</a></li>
                    ...
                    <li><a href="#">
                        <form action="/users/excel/download" method="get">
                            <input type="text" name="role" value="ADMINISTRATOR" hidden>
...
<form action="/users/delete" id="deleteForm" method="post">
    <input type="text" value="" name="userID" id="deleteUserID" hidden>
    <input type="text" value="ADMINISTRATOR" name="role" id="deleteRole" hidden>
</form>
...
<script>
    ...
    document.getElementById("editRole").value="ADMINISTRATOR";
    ...
    function deleteUser(){
        if(clickedRow!=-1){
            ...
            document.getElementById('deleteUserID').setAttribute("value",id);
            clickedRow=-1;
            clicked=0;
